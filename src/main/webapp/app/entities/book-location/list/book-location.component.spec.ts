...
import { sampleWithRequiredData } from '../book-location.test-samples';
...
describe('BookLocation Management Component', () => {
  let comp: BookLocationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BookLocationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bookLocations()[0]).toEqual(expect.objectContaining({ id: 31804 }));
  });

  describe('trackId', () => {
    it('Should forward to bookLocationService', () => {
      const entity = { id: 31804 };
      jest.spyOn(service, 'getBookLocationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBookLocationIdentifier).toHaveBeenCalledWith(entity);
